...
export const ui = {
    en: {
        ...
        "home.tagline":
            "Java 21 and Spring Boot microservices behind an API Gateway, REST APIs and relational models that survive production — plus CCNA networking and CCST cybersecurity foundations. Open to backend, full stack, DevOps and security roles.",
    ...
    es: {
        ...
        "home.tagline":
            "Microservicios en Java 21 y Spring Boot tras un API Gateway, APIs REST y modelos relacionales que aguantan producción — más fundamentos de redes (CCNA) y ciberseguridad (CCST). Abierto a backend, full stack, DevOps y seguridad.",
    ...
    fr: {
        ...
        "home.tagline":
            "Microservices Java 21 et Spring Boot derrière une API Gateway, API REST et modèles relationnels taillés pour la production — avec des bases en réseaux (CCNA) et cybersécurité (CCST). Ouvert au backend, full stack, DevOps et sécurité.",
    ...
    pt: {
        ...
        "home.tagline":
            "Microsserviços em Java 21 e Spring Boot atrás de um API Gateway, APIs REST e modelos relacionais que aguentam produção — mais fundamentos de redes (CCNA) e cibersegurança (CCST). Aberto a backend, full stack, DevOps e segurança.",
