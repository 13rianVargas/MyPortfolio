(function() {
  ...
  function handleClick(e) {
    ...
    const interactiveSelectors = 'button, a, input, textarea, select, [role="button"], .business-card, .card-container, .card-front, .card-back, .flip-hint, nav, header, footer, .scene, .profile-photo, img, svg, path';
